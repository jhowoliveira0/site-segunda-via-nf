        ...
        var t = {
                ...
                var d = {
                    ...
                    keypressEvent: function(e, t, i, a, o) {
                        ...
                        if (!(!0 === t || e.ctrlKey && e.altKey) && (e.ctrlKey || e.metaKey || u.ignorable))
                            return v === r.default.ENTER && u.undoValue !== u._valueGet(!0) && (u.undoValue = u._valueGet(!0),
                            setTimeout((function() {
                                h.trigger("change")
                            }
                            ), 0)),
                            ...
                            var h = function(e, a, r) {
                                ...
                                o = y.length; s < o; s++)
                                    ...
                                    default:
                                        ...
                                        g.push(y[s]),
                                        r.begin--,
                                        r.end--) : y[s] !== l && y[s] !== k && (y[s + 1] === k || b[s] !== y[s] && b[s + 1] === y[s + 1]) ? (m = "insertReplacementText",
                                        g.push(y[s]),
                                        r.begin--) : y[s] === k ? (m = "deleteContentBackward",
                                        (n.isMask.call(t, n.translatePosition.call(t, s), !0) || b[s] === i.radixPoint) && r.end++) : s = o : (m = "insertText",
                                        g.push(y[s]),
                                        r.begin--,
                                        r.end--))
                                    }
            ...
            7760: function(e, t, i) {
                ...
                function d(e, t, i, a, n) {
                    ...
                    c.tests = {},
                    m = f.radixPoint ? o.determineNewCaretPosition.call(l, {
                        begin: 0,
                        end: 0
                    ...
                    if (h.forEach((function(e, t) {
                        if (void 0 !== e) {
                            ...
                            v = "") : g = u.EventHandlers.keypressEvent.call(l, a, !0, !1, i, n + 1),
                    ...
                    for (; a = t ? d.exec(e) : f.exec(e); ) {
                        ...
                        if (p)
                            ...
                            case i.alternatormarker:
                                ...
                                if (c.isAlternator)
                                    v.push(c);
                                else if (c.alternatorGroup ? (u = v.pop(),
                ...
                t.getMaskTemplate = function(e, t, i, a, n) {
                    ...
                    do {
                        if (!0 === e && c.validPositions[k])
                            v = n && c.validPositions[k].match.optionality && void 0 === c.validPositions[k + 1] && (!0 === c.validPositions[k].generatedInput || c.validPositions[k].input == o.skipOptionalPartCharacter && k > 0) ? u.call(r, k, d.call(r, k, p, k - 1)) : c.validPositions[k],
                            h = v.match,
                            p = v.locator.slice(),
                                ...
                                if (r.isGroup && u !== r) {
                                    ...
                                    for (var q = r, z = i.length > 0 ? i.shift() : 0; z < (isNaN(q.quantifier.max) ? z + 1 : q.quantifier.max) && h <= e; z++) {
                                        ...
                                        if (r = s(Q, [z].concat(o), Q)) {
                                            if ((a = m[m.length - 1].match).optionalQuantifier = z >= q.quantifier.min,
                ...
                function l(e, t, i, a, r, s) {
                    ...
                    if (void 0 !== c) {
                        ...
                        for (h = m; h < o.getLastValidPosition.call(x, void 0, !0) + 1; h++)
                            ...
                            C = A.length - 1),
                            (v = S.validPositions[h]) && !0 !== v.generatedInput && (void 0 === s || h < y || h >= b) && A.push(v.input),
                            delete S.validPositions[h];
                        for (-1 === C && void 0 !== t && (A.push(t),
                        C = A.length - 1); void 0 !== S.excludes[m] && S.excludes[m].length < 10; ) {
                            for (S.tests = {},
                    ...
                    return O && !1 === E.keepStatic || delete S.excludes[m],
                    O
                }
                function u(e, t, i) {
                    var a = this.opts
                    ...
                    function E(t, i, r) {
                        ...
                        return n.getTests.call(g, t).every((function(l, c) {
                            ...
                            !1 !== (s = (!d.jit || void 0 !== b.validPositions[o.seekPrevious.call(g, t)]) && (null != d.fn ? d.fn.test(i, b, t, r, y, f.call(g, e)) : (i === d.def || i === y.skipOptionalPartCharacter) && "" !== d.def && {
                                ...
                                !0 !== s && void 0 === s.pos && void 0 === s.c ? !1 : (!1 === m.call(g, e, k.extend({}, l, {
